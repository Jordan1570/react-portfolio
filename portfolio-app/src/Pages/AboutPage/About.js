...
export default function About() {
    return (
        <div>
            <h1 style={{ marginTop: 25, fontFamily: "fantasy", marginLeft: "60px" }}>About</h1>
            <p style={{ fontFamily: "fantasy", fontSize: 24, marginTop: "60px", margin: "60px"}}> 
